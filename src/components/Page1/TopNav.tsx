...
const TopNav: React.FC = () => {
  return (
    <div className="w-full bg-[#0B4196] text-white">
        ...
        <div className="max-w-7xl mx-auto py-3 px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 lg:gap-6">
            <div className="flex items-center gap-4">
              <button className="text-sm hover:text-gray-300 transition-colors whitespace-nowrap">
                REFER
              </button>
              <div className="w-px h-4 bg-gray-600" />
              <button className="text-sm hover:text-gray-300 transition-colors whitespace-nowrap">
      ...
      {/* Mobile Layout - Phone & Email Only */}
      <div className="md:hidden px-4 py-3 space-y-2">
        ...
        >
          ...
          <span className="text-sm">(916) 888-8281</span>
        </a>
        ...
        >
          ...
          <span className="text-sm">contact@pyxelconstruction.com</span>
        </a>
      </div>
    </div>
  );
